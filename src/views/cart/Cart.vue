...
export default {
  ...
  methods: {
    // 0.延展mutations中的方法
    ...mapMutations(['ADD_GOODS', 'REDUCE_GOODS', 'SINGLE_SELECT_GOODS', 'ALL_SELECT_GOODS', 'DELETE_SELECT_GOODS', 'ADD_TO_CART','ADD_LIST']),
    // 1.右上角删除
    clearCart () {
    ...
    onSubmit () {
      ...
      if (this.selectedGoodNum > 0) {
        ...
        // 创建一个订单对象，里面有订单的创建时间，是否支付，订单的商品列表
        let obj = {
        ...
        Toast({
          message: this.order.chooseGoods,
          duration: 1000
        });
      }
    },
